    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('structure', models.CharField(choices=[('standalone', 'Stand-alone order'), ('parent', 'Parent order'), ('child', 'Child order')], default='standalone', max_length=10, verbose_name='Order structure')),
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='order.Order', verbose_name='Parent order')),
                ('partner', models.ForeignKey(db_constraint=False, default=0, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='partner', to='partner.Partner', verbose_name='Partner')),
                ('project', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='content.ContentProjet')),
            ],
            options={
                'verbose_name': 'Order',
