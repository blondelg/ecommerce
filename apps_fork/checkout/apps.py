...
class CheckoutConfig(OscarConfig):
    ...
    def ready(self):
        ...
        # Add view to let customer chose the project he wishes to fund
        self.project_choice_view = get_class('checkout.views', 'ProjectChoiceView')
    ...
    def get_urls(self):
        urls = [
            ...
            # Project choice method views
            url(r'project-choice/$',
                self.project_choice_view.as_view(), name='project-choice'),
