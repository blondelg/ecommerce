...
#from oscar.apps.dashboard.catalogue.apps import CatalogueDashboardConfig as CoreCatalogueDashboardConfig
...
class CatalogueDashboardConfig(apps.CatalogueDashboardConfig):
    ...
    permissions_map = _map = {
        ...
        # Forked element
        'catalogue-product-upload': (['is_staff'],
                                     ['partner.dashboard_access']),
    ...
    def ready(self):
        ...
        # Forked element
        self.product_upload_csv_redirect_view = get_class('dashboard.catalogue.views',
                                                      'ProductUploadCSVRedirectView')
    ...
    def get_urls(self):
        urls = [
            ...
            # Forked element
            url(r'^products/csv/$',
                self.product_upload_csv_redirect_view.as_view(),
